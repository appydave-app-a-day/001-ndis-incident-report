...
export const PostEventSupportClarificationStep: React.FC = () => {
  ...
  useEffect(() => {
    ...
    report.clarificationAnswers.postEvent.forEach(answer => {
      existingAnswers[answer.questionId] = answer.answer;
    });
    setAnswers(existingAnswers);
  }, [report.clarificationAnswers.postEvent]);
  ...
  const handleAnswerChange = (questionId: string, answer: string) => {
    ...
    updateClarificationAnswer('postEvent', questionId, answer);
  };
              ...
              {!isLoadingQuestions && !hasQuestions && (
                <div className="p-8">
                  <Alert>
                    ...
                    <AlertDescription>
                      No clarification questions are available for the "Post-Event Support" phase. You can proceed to the next step.
                    </AlertDescription>
                  </Alert>
                </div>
              )}
                ...
                <div className="p-8">
                  <div className="mb-6">
                    <p className="text-sm text-gray-600 mb-4">
                      These questions are based on your "Post-Event Support" narrative. Answering them is optional but can help provide additional context for your report.
                    </p>
                  </div>
                  
                  <div className="space-y-6">
                    {postQuestions.map((question, index) => (
